...
- File: `lightplayer/crates/lp-glsl/src/frontend/codegen/builtins/common.rs`
...
- File: `lightplayer/crates/lp-glsl/src/frontend/codegen/builtins/` (appropriate module)

## Files to Modify
- `lightplayer/crates/lp-glsl/src/frontend/codegen/builtins/common.rs` - add floatBitsToInt, intBitsToFloat
- `lightplayer/crates/lp-glsl/src/frontend/codegen/builtins/mod.rs` - wire up new functions
