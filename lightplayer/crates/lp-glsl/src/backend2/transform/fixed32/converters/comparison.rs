...
use crate::backend2::transform::fixed32::converters::{extract_binary_operands, get_first_result, map_operand};
...
pub(crate) fn convert_fcmp(
    ...
    if let InstructionData::FloatCompare { cond, args, .. } = inst_data {
        ...
        let scale = builder.ins().iconst(cranelift_codegen::ir::types::I32, 65536);
