//! Core utilities for copying CLIF function components.
//!
//! These utilities handle copying stack slots, blocks, parameters, and value aliases.

use crate::error::{ErrorCode, GlslError};
use cranelift_codegen::ir::{Block, Function, StackSlot, Value};
