...
impl<'a> CodegenContext<'a> {
    ...
    pub fn emit_compound_stmt(&mut self, compound: &glsl::syntax::CompoundStatement) -> Result<(), GlslError> {
        compound::emit_compound_stmt(self, compound)
    }

    pub fn emit_if_stmt(&mut self, selection: &glsl::syntax::SelectionStatement) -> Result<(), GlslError> {
        r#if::emit_if_stmt(self, selection)
    }

    pub fn emit_iteration_stmt(&mut self, iteration: &glsl::syntax::IterationStatement) -> Result<(), GlslError> {
