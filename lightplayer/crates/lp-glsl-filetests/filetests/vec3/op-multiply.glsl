...
vec3 test_vec3_multiply_large_numbers() {
    ...
    return a * b;
    // Should be vec3(3000000.0, 2000000.0, 6000000.0)
}

// run: test_vec3_multiply_large_numbers() ~= vec3(3000000.0, 2000000.0, 6000000.0)

vec3 test_vec3_multiply_mixed_components() {
    vec3 a = vec3(2.0, -3.0, 4.0);
    vec3 b = vec3(-4.0, 5.0, -2.0);
    return a * b;
    // Should be vec3(-8.0, -15.0, -8.0)
}
