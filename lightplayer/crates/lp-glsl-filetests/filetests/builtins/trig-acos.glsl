...
// run: test_acos_half() ~= 1.0471975511965976
...
// run: test_acos_neg_half() ~= 2.0943951023931953
...
// run: test_acos_vec2() ~= vec2(0.0, 1.0471975511965976)
...
// run: test_acos_vec3() ~= vec3(0.0, 1.0471975511965976, 1.5707963267948966)
...
// run: test_acos_vec4() ~= vec4(0.0, 1.0471975511965976, 1.5707963267948966, 2.0943951023931953)
