...
vec2 test_vec2_add_large_numbers() {
    ...
    return a + b;
    // Should be vec2(300000.0, 80000.0)
}

// run: test_vec2_add_large_numbers() ~= vec2(300000.0, 80000.0)
