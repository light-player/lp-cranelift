...
uvec4 test_uvec4_multiply_positive_positive() {
    ...
    return a * b;
    // Should be uvec4(12u, 21u, 8u, 15u)
}
...
uvec4 test_uvec4_multiply_by_one() {
    ...
    return a * b;
    // Should be uvec4(42u, 17u, 23u, 8u)
}
...
uvec4 test_uvec4_multiply_variables() {
    ...
    return a * b;
    // Should be uvec4(56u, 54u, 35u, 24u)
}
...
uvec4 test_uvec4_multiply_in_assignment() {
    ...
    return result;
    // Should be uvec4(12u, 21u, 8u, 18u)
}
...
uvec4 test_uvec4_multiply_large_numbers() {
    ...
    return a * b;
    // Should be uvec4(3000000u, 2000000u, 6000000u, 2000000u)
}
...
uvec4 test_uvec4_multiply_overflow() {
    ...
    return a * b;
    // Should be uvec4(4294967294u, 4294967294u, 4294967294u, 4294967294u) (overflow wrap around)
}
