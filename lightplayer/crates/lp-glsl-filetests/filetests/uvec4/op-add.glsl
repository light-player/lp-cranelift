...
uvec4 test_uvec4_add_variables() {
    ...
    return a + b;
    // Should be uvec4(42u, 15u, 17u, 15u)
}
...
uvec4 test_uvec4_add_in_assignment() {
    ...
    return result;
    // Should be uvec4(15u, 10u, 10u, 10u)
}
...
uvec4 test_uvec4_add_large_numbers() {
    ...
    return a + b;
    // Should be uvec4(300000u, 80000u, 40000u, 15000u)
}
...
uvec4 test_uvec4_add_max_values() {
    ...
    return a + b;
    // Should be uvec4(0u, 4294967295u, 4294967294u, 4294967293u) (wrap around)
}
...
uvec4 test_uvec4_add_mixed_components() {
    ...
    return a + b;
    // Should be uvec4(300u, 125u, 75u, 30u)
}
