...
uvec4 test_uvec4_from_scalar_max() {
    ...
    // Should be uvec4(4294967295u, 4294967295u, 4294967295u, 4294967295u)
}
...
uvec4 test_uvec4_from_scalar_variable() {
    uint x = 42u;
    return uvec4(x);
    // Should be uvec4(42u, 42u, 42u, 42u)
}
...
uvec4 test_uvec4_from_scalar_large_value() {
    ...
    // Should be uvec4(100000u, 100000u, 100000u, 100000u)
}
