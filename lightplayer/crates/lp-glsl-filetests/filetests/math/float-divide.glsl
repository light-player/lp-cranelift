...
mat2 divide_mat2(mat2 a, mat2 b) {
    return a / b;
}

// #run: divide_mat2(mat2(vec2(10.0, 20.0), vec2(30.0, 40.0)), mat2(vec2(2.0, 4.0), vec2(5.0, 8.0))) ~= mat2(vec2(5.0, 5.0), vec2(6.0, 5.0))

mat3 divide_mat3(mat3 a, mat3 b) {
    return a / b;
}

// #run: divide_mat3(mat3(vec3(10.0, 20.0, 30.0), vec3(40.0, 50.0, 60.0), vec3(70.0, 80.0, 90.0)), mat3(vec3(2.0, 4.0, 5.0), vec3(5.0, 10.0, 12.0), vec3(7.0, 8.0, 9.0))) ~= mat3(vec3(5.0, 5.0, 6.0), vec3(8.0, 5.0, 5.0), vec3(10.0, 10.0, 10.0))

mat4 divide_mat4(mat4 a, mat4 b) {
    return a / b;
}

// #run: divide_mat4(mat4(vec4(10.0, 20.0, 30.0, 40.0), vec4(50.0, 60.0, 70.0, 80.0), vec4(90.0, 100.0, 110.0, 120.0), vec4(130.0, 140.0, 150.0, 160.0)), mat4(vec4(2.0, 4.0, 5.0, 8.0), vec4(5.0, 6.0, 7.0, 8.0), vec4(9.0, 10.0, 11.0, 12.0), vec4(13.0, 14.0, 15.0, 16.0))) ~= mat4(vec4(5.0, 5.0, 6.0, 5.0), vec4(10.0, 10.0, 10.0, 10.0), vec4(10.0, 10.0, 10.0, 10.0), vec4(10.0, 10.0, 10.0, 10.0))
