...
uvec2 test_uvec2_add_large_numbers() {
    ...
    return a + b;
    // Should be uvec2(300000u, 80000u)
}
...
uvec2 test_uvec2_add_max_values() {
    ...
    uvec2 b = uvec2(1u, 1u);
    return a + b;
    // Should be uvec2(0u, 4294967295u) (wrap around)
}
