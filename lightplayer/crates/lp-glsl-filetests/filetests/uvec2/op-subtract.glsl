...
uvec2 test_uvec2_subtract_large_numbers() {
    ...
    return a - b;
    // Should be uvec2(300000u, 200000u)
}
...
uvec2 test_uvec2_subtract_underflow() {
    ...
    uvec2 b = uvec2(2u, 1u);
    return a - b;
    // Should be uvec2(4294967295u, 4294967295u) (underflow wrap around)
}
