...
uvec3 test_uvec3_multiply_large_numbers() {
    ...
    return a * b;
    // Should be uvec3(3000000u, 2000000u, 6000000u)
}
...
uvec3 test_uvec3_multiply_overflow() {
    ...
    return a * b;
    // Should be uvec3(4294967294u, 4294967294u, 4294967294u) (overflow wrap around)
}
