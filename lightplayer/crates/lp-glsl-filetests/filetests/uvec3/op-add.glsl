...
uvec3 test_uvec3_add_large_numbers() {
    ...
    return a + b;
    // Should be uvec3(300000u, 80000u, 40000u)
}
...
uvec3 test_uvec3_add_max_values() {
    ...
    return a + b;
    // Should be uvec3(0u, 4294967295u, 4294967294u) (wrap around)
}
