...
uvec3 test_uvec3_from_scalar_max() {
    ...
    // Should be uvec3(4294967295u, 4294967295u, 4294967295u)
}
...
uvec3 test_uvec3_from_scalar_large_value() {
    ...
    // Should be uvec3(100000u, 100000u, 100000u)
}
