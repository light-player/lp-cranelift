...
vec4 test_vec4_multiply_positive_positive() {
    ...
    return a * b;
    // Should be vec4(12.0, 21.0, 8.0, 15.0)
}
...
vec4 test_vec4_multiply_positive_negative() {
    ...
    return a * b;
    // Should be vec4(-15.0, -8.0, -3.0, -8.0)
}
...
vec4 test_vec4_multiply_negative_negative() {
    ...
    return a * b;
    // Should be vec4(8.0, 15.0, 2.0, 6.0)
}
...
vec4 test_vec4_multiply_by_zero() {
    ...
    return a * b;
    // Should be vec4(0.0, 0.0, 0.0, 0.0)
}
...
vec4 test_vec4_multiply_variables() {
    ...
    return a * b;
    // Should be vec4(56.0, 54.0, 35.0, 24.0)
}
...
vec4 test_vec4_multiply_expressions() {
    ...
    // Should be vec4(15.0, 8.0, 5.0, 12.0)
}
...
vec4 test_vec4_multiply_in_assignment() {
    ...
    return result;
    // Should be vec4(12.0, 21.0, 8.0, 18.0)
}
...
vec4 test_vec4_multiply_large_numbers() {
    ...
    return a * b;
    // Should be vec4(3000000.0, 2000000.0, 6000000.0, 2000000.0)
}
...
vec4 test_vec4_multiply_mixed_components() {
    ...
    return a * b;
    // Should be vec4(-8.0, -15.0, -8.0, -6.0)
}
...
vec4 test_vec4_multiply_fractions() {
    ...
    return a * b;
    // Should be vec4(3.0, 1.25, 5.25, 2.0)
}
