...
vec4 test_vec4_add_positive_positive() {
    ...
    return a + b;
    // Should be vec4(7.0, 7.0, 3.0, 4.0)
}
...
vec4 test_vec4_add_positive_negative() {
    ...
    return a + b;
    // Should be vec4(6.0, 6.0, 4.0, 0.0)
}
...
vec4 test_vec4_add_negative_negative() {
    ...
    return a + b;
    // Should be vec4(-5.0, -8.0, -5.0, -6.0)
}
...
vec4 test_vec4_add_zero() {
    ...
    return a + b;
    // Should be vec4(42.0, 17.0, 23.0, 8.0)
}
...
vec4 test_vec4_add_variables() {
    ...
    return a + b;
    // Should be vec4(42.0, 15.0, 17.0, 15.0)
}
...
vec4 test_vec4_add_expressions() {
    ...
    // Should be vec4(14.0, 6.0, 9.0, 6.0)
}
...
vec4 test_vec4_add_in_assignment() {
    ...
    return result;
    // Should be vec4(15.0, 10.0, 10.0, 10.0)
}
...
vec4 test_vec4_add_large_numbers() {
    ...
    return a + b;
    // Should be vec4(300000.0, 80000.0, 40000.0, 15000.0)
}

// run: test_vec4_add_large_numbers() ~= vec4(300000.0, 80000.0, 40000.0, 15000.0)

vec4 test_vec4_add_mixed_components() {
    vec4 a = vec4(1.0, -2.0, 3.0, -4.0);
    vec4 b = vec4(-3.0, 4.0, -1.0, 2.0);
    return a + b;
    // Should be vec4(-2.0, 2.0, 2.0, -2.0)
}
...
vec4 test_vec4_add_fractions() {
    ...
    return a + b;
    // Should be vec4(2.0, 4.0, 4.0, 2.0)
}
