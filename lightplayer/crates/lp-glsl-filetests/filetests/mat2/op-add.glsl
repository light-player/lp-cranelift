...
mat2 test_mat2_add_simple() {
    ...
    return a + b;
    // Should be mat2(1.5, 3.5, 5.5, 7.5)
}
...
mat2 test_mat2_add_identity() {
    ...
    return a + b;
    // Should be mat2(1.0, 0.0, 0.0, 1.0)
}
...
mat2 test_mat2_add_variables() {
    ...
    return a + b;
    // Should be mat2(5.0, 5.0, 5.0, 5.0)
}
...
mat2 test_mat2_add_expressions() {
    ...
    // Should be mat2(1.5, 2.5, 3.5, 4.5)
}
...
mat2 test_mat2_add_in_assignment() {
    ...
    return result;
    // Should be mat2(1.1, 2.2, 3.3, 4.4)
}
...
mat2 test_mat2_add_large_values() {
    ...
    return a + b;
    // Should be mat2(2000.0, 4000.0, 6000.0, 8000.0)
}
