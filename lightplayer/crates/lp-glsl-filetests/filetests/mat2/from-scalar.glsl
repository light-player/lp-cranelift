...
mat2 test_mat2_from_scalar_positive() {
    ...
    return mat2(5.0);
    // Should be mat2(5.0, 0.0, 0.0, 5.0)
}
...
mat2 test_mat2_from_scalar_negative() {
    return mat2(-3.0);
    // Should be mat2(-3.0, 0.0, 0.0, -3.0)
}
...
mat2 test_mat2_from_scalar_one() {
    return mat2(1.0);
    // Should be mat2(1.0, 0.0, 0.0, 1.0) (identity matrix)
}
...
mat2 test_mat2_from_scalar_variable() {
    float x = 2.5;
    return mat2(x);
    // Should be mat2(2.5, 0.0, 0.0, 2.5)
}
...
mat2 test_mat2_from_scalar_function_result() {
    ...
    // Should be mat2(7.0, 0.0, 0.0, 7.0)
}
...
mat2 test_mat2_from_scalar_in_assignment() {
    ...
    result = mat2(4.0);
    return result;
    // Should be mat2(4.0, 0.0, 0.0, 4.0)
}
...
mat2 test_mat2_from_scalar_large_value() {
    return mat2(1000.0);
    // Should be mat2(1000.0, 0.0, 0.0, 1000.0)
}
...
mat2 test_mat2_from_scalar_fractional() {
    return mat2(0.5);
    // Should be mat2(0.5, 0.0, 0.0, 0.5)
}
