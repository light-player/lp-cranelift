...
float test_mat2_determinant_variables() {
    ...
    return determinant(m);
    // Should be 1.5*4.5 - 2.5*3.5 = 6.75 - 8.75 = -2.0
}
...
float test_mat2_determinant_fractional() {
    ...
    return determinant(m);
    // Should be 0.5*3.5 - 1.5*2.5 = 1.75 - 3.75 = -2.0
}
