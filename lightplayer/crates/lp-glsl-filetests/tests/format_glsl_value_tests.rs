...
fn test_format_mat3x3() {
    ...
    // Internal representation (row-major view): [[1.0, 4.0, 7.0], [2.0, 5.0, 8.0], [3.0, 6.0, 9.0]]
    let mat = GlslValue::Mat3x3([
        [1.0, 4.0, 7.0],  // row 0: col0=1.0, col1=4.0, col2=7.0
        [2.0, 5.0, 8.0],  // row 1: col0=2.0, col1=5.0, col2=8.0
        [3.0, 6.0, 9.0],  // row 2: col0=3.0, col1=6.0, col2=9.0
    ]);
    ...
    assert_eq!(formatted, "mat3(vec3(1.0, 2.0, 3.0), vec3(4.0, 5.0, 6.0), vec3(7.0, 8.0, 9.0))");
...
fn test_format_mat4x4() {
    ...
    // Internal representation (row-major view):
    let mat = GlslValue::Mat4x4([
        [1.0, 5.0, 9.0, 13.0],   // row 0: col0=1.0, col1=5.0, col2=9.0, col3=13.0
        [2.0, 6.0, 10.0, 14.0],  // row 1: col0=2.0, col1=6.0, col2=10.0, col3=14.0
        [3.0, 7.0, 11.0, 15.0],  // row 2: col0=3.0, col1=7.0, col2=11.0, col3=15.0
        [4.0, 8.0, 12.0, 16.0],  // row 3: col0=4.0, col1=8.0, col2=12.0, col3=16.0
    ]);
    ...
    assert_eq!(formatted, "mat4(vec4(1.0, 2.0, 3.0, 4.0), vec4(5.0, 6.0, 7.0, 8.0), vec4(9.0, 10.0, 11.0, 12.0), vec4(13.0, 14.0, 15.0, 16.0))");
