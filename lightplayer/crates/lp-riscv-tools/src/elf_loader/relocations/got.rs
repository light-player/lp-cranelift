...
impl GotTracker {
    ...
    pub fn add_entry(&mut self, symbol_name: String, address: u32) {
        ...
        self.entries.insert(symbol_name.clone(), GotEntry {
            symbol_name,
            address,
            initialized: false,
        });
...
pub fn identify_got_entries(
    relocations: &[super::phase1::RelocationInfo],
) -> GotTracker {
    ...
    for reloc in relocations {
        ...
        if reloc.r_type == 1 { // R_RISCV_32
            ...
            let is_got_entry = reloc.symbol_name.starts_with("__lp_") ||
