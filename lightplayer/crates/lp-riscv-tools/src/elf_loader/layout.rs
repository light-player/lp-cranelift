...
use super::memory::{RAM_START, is_rom_address, is_ram_address};
...
pub fn calculate_memory_layout(obj: &object::File, entry_point: u32) -> Result<MemoryLayout, String> {
    ...
    for section in obj.sections() {
        ...
        debug!("  Section '{}': addr=0x{:x}, size={}", section_name, section_addr, section_size);
    ...
    debug!("Calculated layout: ROM={} bytes (max addr: 0x{:x}), RAM={} bytes (max offset: 0x{:x})", 
